...
func SetRouteGroup(public, protected *gin.RouterGroup) {
	...
	mdProtected.PUT("/:markdownId", handler.UpdateHandler)    // PUT /api/v1/protected/markdown/:markdownId 更新自己的文章
	mdProtected.DELETE("/:markdownId", handler.DeleteHandler) // DELETE /api/v1/protected/markdown/:markdownId 删除自己的文章
}
