// pemgenerator — RSA 密钥对生成
//
// 用法:
//	go run utils/pemgenerator/main.go             → 默认输出到 configs/
//	go run utils/pemgenerator/main.go -out ./keys → 指定输出目录
//	go run utils/pemgenerator/main.go -bits 4096  → 指定密钥长度
package main
